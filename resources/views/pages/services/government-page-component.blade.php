                    ...
                    <accordion-item inline-template>
                        <div class="accordion-item">
                            ...
                            <div v-show="showText" transition="expand" class="accordion-text">
                                ...
                                <p>If you would like more information, please click <a href="www.health.gov.au/internet/main/publishing.nsf/Content/ health-medicare-allied-health-brochure.htm">here</a>.</p>
                            </div>
                        </div>
                    </accordion-item>
                    ...
                    <accordion-item inline-template>
                        <div class="accordion-item">
                            ...
                            <div v-show="showText" transition="expand" class="accordion-text">
                                ...
                                <p>If you would like more information, please click <a href="factsheets.dva.gov.au/factsheets/documents/ HSV13%20Chiropractic%20Services.htm">here</a>.</p>
                            </div>
                        </div>
                    </accordion-item>
                        ...
                        <div class="accordion-item">
                            ...
                            <div v-show="showText" transition="expand" class="accordion-text">
                                <p>The National ADF Family Health Program provides $400 for each registered dependant per financial year to
                                    ...
                                    year).</p>
                                <p>If you would like more information, please click <a href="www.defence.gov.au/Health/SHC/DependantHealthcare/
                                    default.asp">here</a>.</p>
                            </div>
                        </div>
                    </accordion-item>
                </div>
