<script id="rnr-page-template" type="x-template">
    ...
    <div id="rnr" class="service">
        ...
        <div class="text scrollbar-container">
            ...
            <p>Hard-wired into the nervous system (specifically the brainstem) are a number of reflexes which help children survive the birthing process and the early stages of life before they develop the ability to make decisions. These are called 'primitive' or 'neonatal' reflexes.</p>
            ...
            <p>If you would like more information about each individual reflex and the symptoms commonly-associated with them, please click <a href="http://www.retainedneonatalreflexes.com.au/reflexes-explained/">here</a>.</p>
        </div>
    </div>
